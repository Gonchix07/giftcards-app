-- ============================================================
--  Migración: agregar vencimiento a las Gift Cards
--  Ejecutar SOLO si ya corriste schema.sql antes de esta feature.
--  (Si instalás desde cero con el schema.sql actualizado, no hace falta.)
-- ============================================================

alter table public.giftcards
  add column if not exists fecha_vencimiento date;

-- Reemplaza la función para validar el vencimiento al usar la tarjeta

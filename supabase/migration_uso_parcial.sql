-- ============================================================
--  Migración: uso parcial o total de la Gift Card
--   - Columna uso_parcial (true = admite parciales; false = solo total)
--   - usar_giftcard exige el saldo completo cuando uso_parcial = false
--  Ejecutar en Supabase -> SQL Editor -> Run.
-- ============================================================

alter table public.giftcards add column if not exists uso_parcial boolean not null default true;
